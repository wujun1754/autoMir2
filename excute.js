...
var tools = {
    ...
    常用操作: {
        ...
        检查武器衣服持久: () => {
            ...
            if (挂机参数.武器持久0回程 == 1 && 武器.status && 武器.持久 && 武器.持久.剩持久 <= 2) {
                ...
                if (!是否用过备用武器) {
                    if (挂机参数.备用凝霜 == 1) {
                        isSuccess = tools.常用操作.使用备用装备(装备枚举.凝霜);
                    }
                    else if (挂机参数.备用凌风 == 1) {
                        isSuccess = tools.常用操作.使用备用装备(装备枚举.凌风);
                    }
    ...
    执行时间戳: {
        ...
        检测背包是否已满: (强制检测) => {
            if (new Date().getTime() - 上次检查背包是否已满时间 > 检查背包是否已满时间戳 || 强制检测) {
    ...
    挂机打怪: {
        ...
        向怪物移动: () => {
            ...
            while (true) {
                ...
                if (Math.abs(r.x - 人物中心.x) <= 允许距离.x && Math.abs(r.y - 人物中心.y) <= 允许距离.y) {
                ...
                //     //         else {
                //     //             sleep(点击延时)
                //     //             tools.悬浮球描述("点击右边空位成功")
                //     //         }
                //     //     }
                //     //     continue
                //     // }
                //     // if (Math.abs(y - 人物中心.y) > 允许距离.y) {
                //     //     if (y < 人物中心.y) {
                //     //         var r = tools.人物移动.点击上边空位(false);
                //     //         if (!r) {
                //     //             tools.人物移动.上走一步(duartion)
                //     //         }
                //     //         else {
                //     //             sleep(点击延时)
                //     //             tools.悬浮球描述("点击上边空位成功")
                //     //         }
                //     //     }
                //     //     else {
                //     //         var r = tools.人物移动.点击下边空位(false);
                //     //         if (!r) {
                //     //             tools.人物移动.下走一步(duartion)
                //     //         } else {
                //     //             sleep(点击延时)
                //     //             tools.悬浮球描述("点击下边空位成功")
                //     //         }
    ...
    人物移动: {
        ...
        去下一层地图: (当前地图, 目的地) => {
            ...
            var routes = null; 
            if (下一层 && 下一层.入口 && 箭头P.status && Math.abs(箭头P.r.x - 下一层.入口.x) > 35 && Math.abs(箭头P.r.y - 下一层.入口.y) > 35) {
