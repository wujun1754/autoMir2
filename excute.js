...
let window = floaty.window(
    <frame padding="2" id="xuanFuPanel" w="wrap_content" h="wrap_content">
        <horizontal>
            <text id="bbText" text="v:6.9.31" textSize="8sp" textColor="#ffffff" marginRight="3" />
    ...
    执行时间戳: {
        ...
        检测背包是否已满: () => {
            if (new Date().getTime() - 上次检查背包是否已满时间 > 检查背包是否已满时间戳) {
                ...
                var r = tools.常用操作.检查背包是否有东西("5_7");
                if (r) {
            ...
            if (isShiQu) {
                ...
                while (当前总状态 == 总状态.已启动) {
                    ...
                    if (r.status) {
                        ...
                        if (!是否隐身等待 && 挂机参数.隐身走动 == 1 && 锁定的怪物.length > 0) {
                        ...
                        tools.悬浮球描述("(" + parseInt((timeout - (时间戳)) / 1000) + "),(" + 锁定的怪物 + "),isChange(" + isChange + ")" + 宝宝位置 + "");
                        //sleep(111);
                    } else {
                        tools.挂机打怪.开始拾取();
                        if (挂机参数.只打满血怪 == 1) {
                            ...
                            if (r.status && r.value && r.value.length > 0) {
                                ...
                                var x = item.x + 20;
                                var y = item.y;
                                if (x >= 824 && x <= 891 && y >= 472 && y <= 537) { //避免点到金令
    ...
    补给操作: {
        ...
        获取背包操作按钮(type, isClick) {//type=1表示放入按钮、2表示购买、3表示修理
            ...
            switch (type) {
                ...
                case 3:
                    ...
                    if (!r.status) {
                        ...
                        if (r.status) {
                            tools.常用方法.错误日志(btnName + "找图成功", 3);
                        }
                    }
                    break;
            }
            if (r.status) {
                ...
                tools.常用方法.错误日志(btnName + "找图失败", 3);
                return {
                    status: false,
                    btnName: btnName
                }
                    ...
                    if (r.status) {
                        ...
                        if (r && (r.x > 0 || r.y > 0)) {
                            ...
                            if (r) {
                                ...
                                tools.常用方法.错误日志("beibaofangruBtn和beibaofangruBtn1找图失败", 3);
        ...
        //             var fangruName = "beibaofangruBtn.png";
        ...
        //             }
        //             if (r.status) {
        //                 if (fangruName == "beibaofangruBtn.png") {
        ...
        //                 }
        //                 else {
        //                     tools.常用方法.错误日志("使用beibaofangruBtn1.png找图成功", 3);
        //                 }
            ...
            for (var index = 0; index < arr.length; index++) {
                ...
                if (!r.status) {
                    ...
                    if (r.status) {
                        ...
                        tools.常用方法.错误日志("xiexia1.png和xiexia1.png找图都失败", 3);
                    }
                }
