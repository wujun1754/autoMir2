...
let 检测人物血条错误次数 = 0;
let 上一次检测人物血条时间 = new Date().getTime();
let 检测人物血条时间时间戳 = 60 * 1000 * 5;
...
var 上次检查背包时间 = new Date().getTime(); // 减去 20 分钟; 
...
var 禁止扫描宝宝身边时间 = new Date().getTime() - 1000 * 60 * 24;// 减去 24小时;
var 禁止拾取时间 = new Date().getTime() - 1000 * 60 * 24;// 减去 24小时;

var 上一次武器持久提示时间 = new Date().getTime() - 1000 * 60 * 24;
var 上一次衣服持久提示时间 = new Date().getTime() - 1000 * 60 * 24;

let 上次跑图时间 = new Date().getTime() - (60 * 1000);

var 上一次点拾取时间 = new Date().getTime() - (60 * 1000);
var 上一次激活拾取时间 = new Date().getTime() - (60 * 1000);

var 激活拾取时间戳 = 3000;

var 上一次点击左面板怪物时间 = new Date().getTime() - (60 * 1000);
...
var 存仓库枚举 = {
    ...
    无极棍: "wenzi_zhuangbei_wujigun.png",
    召唤神兽: "wenzi_zhuangbei_shenshou.png",
    天珠项链: "wenzi_zhuangbei_tianzhu.png",
    红宝石: "wenzi_zhuangbei_hongbaoshi.png",
    绿色项链: "wenzi_zhuangbei_lvse.png",
    龙纹: "wenzi_zhuangbei_longwenjian.png",
    井中月: "wenzi_zhuangbei_jingzhongyue.png",
    铃铛: "wenzi_zhuangbei_lingdang.png",
}
var 文字图枚举 = {
    斩: "wenzi_zhan.png",
    镯: "wenzi_zhuo.png",
    ...
    灵: "wenzi_youling.png",
    髅左面板: "wenzhi_zuomianban_kulou_lou.png",
    休息: "wenzhi_xiuxi.png",
...
var 左怪物文字枚举 = {//不要随便动顺序，精英怪枚举有写死
    蜈蚣洞: [
        ...
        },
        {
            ...
            怪物显示图: "wenzi_wugongdong_xing.png",
            左上血条偏移: {
                '720_1280': {
                    x: -6,
                    y: -51
    ...
    石墓阵: [
        {
            精英怪: false,
            name: "黑色恶蛆",
            pic: "wenzhi_zuomianban_shimu_se.png",
            怪物显示图: "wenzi_shimu_se.png",
            左上血条偏移: {
                '720_1280': {
                    x: -4,
                    y: -51
        ...
        },
        {
            精英怪: false,
            name: "红黑猪",
            pic: "wenzhi_zuomianban_shimu_zhu.png",
            怪物显示图: "wenzi_shimu_zhu.png",
            左上血条偏移: {
                '720_1280': {
                    x: -8,
                    y: -51
        ...
        },
        {
            精英怪: false,
            name: "蝎蛇",
            pic: "wenzhi_zuomianban_shimu_xieshe.png",
            怪物显示图: "wenzi_shimu_xieshe.png",
            左上血条偏移: {
                '720_1280': {
                    x: -21,
                    y: -51
        ...
        },
        {
            精英怪: false,
            name: "楔蛾",
            pic: "wenzhi_zuomianban_shimu_qi.png",
            怪物显示图: "wenzi_shimu_qi.png",
            左上血条偏移: {
                '720_1280': {
                    x: -5,
                    y: -51
        ...
        },
        {
            精英怪: true,
            name: "白野猪",
            pic: "wenzhi_zuomianban_shimu_bai.png",
            怪物显示图: "wenzi_shimu_bai.png",
            左上血条偏移: {
                '720_1280': {
                    x: 3,
                    y: -51
    ...
    牛魔洞: [
        ...
        },
        {
            精英怪: false,
            name: "宝箱",
            pic: "wenzhi_zuomianban_niumo_xiang.png",
            怪物显示图: "wenzhi_zuomianban_niumo_xiang.png",
            左上血条偏移: {
                '720_1280': {
                    x: -4,
                    y: -51
...
var 怪物排除枚举 = {//不要随便动顺序，精英怪枚举有写死
    蜈蚣洞: [],
    骷髅洞: ["wenzhi_zuomianban_kulou_dong.png", "wenzhi_zuomianban_kulou_xie.png"],
    石墓阵: ["wenzhi_zuomianban_shimu_qi.png"],
    牛魔洞: []
};
...
var 强制拾取枚举 = [
    ...
    // {   //这玩意和金币有冲突
    //     text: "金手镯",
    //     pic: "wenzhi_shiqu_jinshou.png"
    // },
    {
        text: "盔",
        pic: "wenzhi_shiqu_kui.png"
    },
    {
        text: "降妖",
        pic: "wenzhi_shiqu_kui.png"
...
var 强制拾取排除枚举 = [
    {
        text: "金币1",
        pic: "wenzhi_shiqu_jingbi1.png"
    },
    {
        text: "金币2",
        pic: "wenzhi_shiqu_jingbi2.png"
    },
    {
        text: "金币3",
...
let windowTemp = floaty.window(
    <frame padding="2" id="xuanTempCommon" bg="#000000">
        <horizontal>
            <text id="clearText" text=" X " textSize="9sp" textColor="#ffffff" />
            <text id="temp1Text" text="" textSize="8sp" textColor="#ffffff" />
            <text text=" | " textSize="8sp" textColor="#ffffff" />
            <text id="temp3Text" text="" textSize="8sp" textColor="#ffffff" />
            <text id="temp5Text" text="" textSize="8sp" textColor="#ffffff" />
            <text text=" | " textSize="8sp" textColor="#ffffff" />
            <text id="temp4Text" text="" textSize="8sp" textColor="#ffffff" />
        </horizontal>
    </frame>
);
    ...
    <frame gravity="center" id="configFrame">
        <vertical w="{{w}}" h="{{h}}">
            ...
            <vertical id="content" paddingLeft="6">
                ...
                <vertical id="view2" visibility="gone" gravity="center">
                    ...
                    <horizontal>
                        ...
                        <horizontal gravity="right">
                            <checkbox id="cbTiHuanMingZhu" text="检宠身边" textSize="10sp" />
                        </horizontal>
                        <horizontal gravity="right">
                    ...
                    <horizontal>
                        ...
                        <horizontal gravity="right">
                            <checkbox id="cbTiHuanDaoDe" text="替换珊瑚" textSize="10sp" />
                        </horizontal>
                    </horizontal>
                    <horizontal>
                        <horizontal gravity="right">
                        ...
                        <horizontal gravity="right">
                            <checkbox id="cbIsWuFeiHuiCheng" text="是否队长" textSize="10sp" />
                        </horizontal>
                        <horizontal gravity="right">
                        ...
                        <horizontal gravity="right">
                            <checkbox id="cbDiTuTuoDong" text="躲避精英" textSize="10sp" />
                        </horizontal>

                        <horizontal gravity="right">
                            <checkbox id="cbIsGenSuiBaoBao" text="扫描精英" textSize="10sp" />
                        </horizontal>
                    </horizontal>
                    <horizontal>
                        <horizontal gravity="left">
            ...
            <horizontal paddingLeft="3">
                <button id="btnStart" textSize="8sp" style="Widget.AppCompat.Button.Colored" text="暂停" />
...
var tools = {
    ...
    组队: {
        ...
        获取好友Id: () => {
            var result = [];
            var arr = [];
            var val = 挂机参数.组队.toString();
            var msg = "split 前的类型:" + typeof val + " | 值:" + val;
            try {
                arr = val.split(",");
            } catch (e) {
                msg += "异常信息:" + e.name + " " + e.message;
                arr = null;
                tools.常用方法.发送提醒("获取好友Id字符串异常(" + msg + ")");
            }
            ...
            组队: () => {
                ...
                if (arr != null && arr.length > 0) {
                    ...
                    for (var index = 0; index < arr.length; index++) {
                        ...
                        tools.悬浮球描述Temp("已完成" + name + "组队Id=" + Id);
                    }
                    tools.click(取消.x + random(-3, 3), 取消.y + random(-3, 3))
                    sleep(1200);
                    tools.常用操作.关闭所有窗口();
                }
            },
    ...
    常用方法: {
        ...
        初始化参数: () => {
            ...
            if (挂机参数.唯一ID && 挂机参数.唯一ID > 0) {
                win.t_OnlyID.setText(挂机参数.唯一ID.toString());
            } else {
                win.t_OnlyID.setText("");
            }
            if (挂机参数.跟随几格) {
        ...
        设置背景光: (value) => {
            shell("echo " + value + " > /sys/class/backlight/panel0-backlight/brightness", true);
        },
        截图回传: () => {
            var p = config.zuobiao.截图回传[fbl];
            var imgs = tools.截屏裁剪(null, p.x1, p.y1, p.x2, p.y2);
            var base64Str = android.util.Base64.encodeToString(images.toBytes(imgs, "png"), 30);
            var msg = JSON.stringify({
                type: -4,
                account: 挂机参数.机器标识,
                Id: 挂机参数.唯一ID,
        ...
        设置物品: () => {
            var 物品坐标 = config.物品坐标;
            for (var index1 = 0; index1 < config.物品设置.length; index1++) {
                var page = config.物品设置[index1];
                for (let index2 = 0; index2 < page.length; index2++) {
                    var item = page[index2];
                    var p = 物品坐标[index2];
                    if (item[0] == 0) {
                        tools.click(p.x1, p.y)
                        sleep(666);
                    }
                    if (item[1] == 0) {
                        tools.click(p.x2, p.y)
                        sleep(666);
                    }
                }
                tools.click(1028, 497)
                sleep(888);
            }
            toastLog("设置完成")
        },
    ...
    常用操作: {
        及时执行事件: (是否检测组队, 来源, 是否检测血量) => {
            ...
            if (是否完成Socket链接 && 当前总状态 == 总状态.已启动 && 挂机参数.是否队长 == 1) {
                ...
                if (tools.Socket.是否有队员申请 && 是否检测组队) {
                    tools.执行时间戳.队长组人();
                }
        ...
        打开背包: () => {
            ...
            var r = tools.findImageAreaForWaitClick("beibaoBtn.png", p.x[0] - 50, p.y[0] - 50, p.x[1] + 100, p.y[1] + 100, {
                maxTries: 10,
                interval: 100
            })
            if (!r.status) {
        ...
        小退: (msg, 是否强制) => {
            if (是否强制) {
                ...
                var 是否在安全图 = config.禁止小退.some(item => item === 当前地图)
                if (是否在安全图) {
                    return;
                }
            }
            var x = 1240 + random(-5, 5);
        ...
        检查包袱: () => {
            ...
            var r = tools.常用操作.检查背包是否已满(zhengliBtn);
            if (r) {
        ...
        获取人物地图: (清空非目标) => {
            ...
            if (result != null && result.length > 0) {
                ...
                result = tools.常用操作.处理地图错别字(result[0].text, 清空非目标);
                if (上次所在地图 != result) {
                    上次所在地图 = result;
                    if (
                        挂机参数.挂机地图 != "比奇野外"
        ...
        使用备用装备: (picName, zhengliBtn) => {
            ...
            sleep(666);
            var r = tools.findImageAreaClick(picName, 背包面板P.x1, 背包面板P.y1, 背包面板P.x2, 背包面板P.y2, 0.8);
            if (r) {
                r = tools.补给操作.获取操作按钮(["穿戴"], "寻找装备", false, false);
                if (!r.status) {
                    sleep(666)
                    tools.常用操作.点击左面板怪物();
                }
                ...
                var btn = r.value;
                var result = tools.补给操作.背包选中按钮中找字图(文字图, btn)
                if (result.status) {
                    sleep(999)
        ...
        处理地图错别字: (text, 清空非目标) => {
            ...
            else if ((text.indexOf("幽") >= 0 || text.indexOf("名") >= 0) && (text.indexOf("圣") >= 0 || text.indexOf("域") >= 0)) {
                text = "幽名圣域"
                isok = true;
            }
        ...
        点击左面板人物: () => {
            if (fbl == "1080_2248") {
                tools.click(random(110, 120), random(245, 265));
            }
            else {
        ...
        点击左面板怪物: () => {
            if (fbl == "1080_2248") {
                tools.click(random(115, 125), random(435, 455));
            }
            else {
            ...
            if (currentPackage() != 盛趣包名) {
                ...
                if (r.status) {
                    ...
                    if (r.status) {
                        ...
                        press(440 + random(5, 15), 272 + random(-5, 5), 3500);//长按密码框


                        sleep(random(1500, 2000))
                        //loginzhantie.png   loginzhantie1.png


                        r = tools.findImageForWaitClick("loginzhantie1.png", {
                            maxTries: 5,
                            interval: 1000
                        })
                        sleep(random(1500, 2000))
                        if (r.status) {
                            ...
                            tools.悬浮球描述Temp("密码未发现粘贴")
                            return;
                        }
                    }
                }

                r = tools.findImageAreaForWait("start_yanzhengma.png", 660, 190, 800, 260, {
                    maxTries: 10,
                    interval: 1000
                })
                ...
                if (r.status) {
                    r = tools.验证码认证.登录验证码();
                    if (r.status) {
                        setClip(r.value);//输入密码
                        sleep(random(1500, 2000));

                        press(615 + random(10, 15), 401 + random(-5, 5), 3500);//长按验证码框
                        ...
                        if (r.status) {
                            sleep(random(1200, 1500))
                            click(644 + random(-5, 5), 504 + random(-5, 5)) //点击确定
                            sleep(random(2000, 3000))
                            ...
                            tools.悬浮球描述Temp("粘贴验证失败")
                            return;
                        }

                    }
                    else {
                        tools.悬浮球描述Temp("登录验证码远程失败")
                        return;
                    }
                }
                ...
                r = tools.findImageAreaForWait("start_kaishiend.png", 590, 530, 710, 600, {
                    maxTries: 30,
                    interval: 1000
                })
        ...
        跑图累计错误执行: () => {
            if (跑图错误次数 >= 6) {
                var 人物地图 = tools.常用操作.获取人物地图(true);
                if (人物地图 == null || 人物地图.length <= 0) {
                    tools.人物移动.使用地牢();
                }
                else {
                    toastLog("跑图错误6次");
                    ...
                    tools.常用操作.关闭所有窗口();
                    tools.挂机打怪.宝宝是否存在("攻击", false, false);
    ...
    执行时间戳: {
        ...
        检测背包: (强制检测) => {
            var 检查时间戳 = 60 * 1000 * 10;
            if ((new Date().getTime() - 上次检查背包时间 > 检查时间戳) || 强制检测) {
                tools.悬浮球描述("检查背包开始");
                var r = tools.常用操作.检查包袱();
                if (r.status) {
                    tools.挂机打怪.回城补给在挂机(r.msg);
                }
                上次检查背包时间 = new Date().getTime();
                tools.悬浮球描述("检查背包结束");
            }
        },
        检测操作模式: (强制检测) => {
        ...
        检测人物血条是否存在: () => {
            if (new Date().getTime() - 上一次检测人物血条时间 > 检测人物血条时间时间戳) {
                var r = tools.常用操作.检测人物血条是否存在();
                var result = true;
                if (!r) {
                    r = tools.常用操作.检测是否在游戏画面();
                    if (!r) {
                        var closeBtn = tools.findImage("closeBtn.png", 0.9);
                        if (!closeBtn.status) {
                            result = false;
                        }
                    }
                ...
                if (result) {
                    ...
                    检测人物血条错误次数++;
                    if (检测人物血条错误次数 >= 2) {
                        tools.常用方法.发送提醒("未找到人物血量");
                    }
                }
                上一次检测人物血条时间 = new Date().getTime();
            }
        },
    ...
    挂机打怪: {
        启动执行: () => {
            ...
            if (now - 上次跑图时间 > 跑图时间戳 && 当前总状态 == 总状态.已启动) {
                开启寻怪 = true;
                var 当前地图 = tools.常用操作.获取人物地图();
        ...
        锁定怪物: () => {
            ...
            if (挂机参数.挂机地图大 == "蜈蚣洞") {
                if (挂机参数.躲避精英 != 1) {
                    r = tools.挂机打怪.匹配指定怪物(精英怪枚举.邪恶蚶虫.pic, 0.55, false, true, true);
                    if (r.status) {
                        锁定怪物顺序 = r.index;
                        isFind = true;
                        是否继续寻找 = false;
                ...
                if (是否继续寻找) {
                    r = tools.挂机打怪.匹配指定怪物(精英怪枚举.巨型蠕虫.pic, 0.55, (挂机参数.只打满血怪 == 1 ? true : false), true, true);
                    if (r.status) {
                        锁定怪物顺序 = r.index;
                        isFind = true;
                        是否继续寻找 = false;
            ...
            if (是否继续寻找) {
                var 其他玩家 = false;
                if (挂机参数.隐身走动 == 1) {
                    if (new Date().getTime() - 上一次点击左面板怪物时间 >= 1000 * 10) {
                        tools.常用操作.点击左面板怪物();
                        上一次点击左面板怪物时间 = new Date().getTime();
                    }
            ...
            if (isFind) {
                tools.挂机打怪.截图锁定怪物(锁定怪物顺序)
                上次坐标截图 = tools.常用操作.截图当前坐标();
                var 左面板怪物 = tools.挂机打怪.分析左面板怪物()
                ...
                tools.执行时间戳.检测武器衣服(false);
                tools.执行时间戳.检测背包(false);
                tools.执行时间戳.检测画面();
                tools.常用操作.及时执行事件(false, "锁定怪物", true);
                var now = new Date().getTime();
                if (now >= 禁止拾取时间 && now - 上一次激活拾取时间 > 激活拾取时间戳 && tools.拾取.扫描拾取(null, true)) {
                    tools.拾取.点击(1, "锁怪");
                    tools.拾取.等待();
                    tools.拾取.激活后操作();
                }
                if (now - 上次打怪时间 >= 1000 * 60 * 2) {
                    tools.常用操作.初始化攻击面板loops();
        ...
        匹配指定怪物: (picName, threshold, 是否满血, 是否锁定, 是否攻击) => {
            var img = captureScreen();
            ...
            if (arr && arr.count > 0) {
                ...
                if (是否满血) {
                    for (var index = 0; index < arr.count; index++) {
                        ...
                        var r = tools.挂机打怪.找满血怪(顺序p.index, 是否锁定, 是否攻击);
                        if (r.status) {
                            result = {
                                status: true,
                                index: 顺序p.index,
        ...
        截图锁定怪物: (锁定怪物顺序) => {
            if (锁定怪物顺序 >= 0) {
                var p = config.zuobiao.左攻击面板[fbl];
                var YInfo = config.zuobiao.左攻击面板[fbl].Y轴顺序[锁定怪物顺序];
                utils.recycleNull(锁定怪物截图);
                锁定怪物截图 = tools.截屏裁剪(null, p.文字区域.x1, YInfo.y1, p.文字区域.x2, YInfo.y2);
            }
        },
        获取锁定怪物顺序: (y) => {
            var r = {
                status: false,
                x中心: config.zuobiao.左攻击面板[fbl].X血量中心,
                y1: 0,
                y2: 0,
                index: 0
            }
            var p = config.zuobiao.左攻击面板[fbl].Y轴顺序;//config.左攻击面板[fbl];
            if (y > 0) {
        ...
        攻击怪物: () => {
            ...
            var 是否允许拾取 = true;
            while (当前总状态 == 总状态.已启动) {
                var 提前结束 = tools.挂机打怪.是否提前结束攻击(start, 精英怪, 向怪物移动次数);
                if (提前结束.status) {
                    if (提前结束.强制跑图) {
                        tools.挂机打怪.关闭中间怪物(提前结束.msg);
                        tools.挂机打怪.强制跑图();
                    }
                    if (挂机参数.隐身走动 == 1) {
                        tools.常用操作.点击左面板怪物();
                ...
                var 攻击状态 = tools.挂机打怪.判断攻击状态(精英怪);
                ...
                if (是否允许拾取) {
                    if (tools.挂机打怪.判断经验增加()) {
                        tools.拾取.点击(1, "经验");
                        tools.挂机打怪.快速检查宝宝();
                        tools.拾取.等待();
                        tools.拾取.激活后操作();
                    }
                    else if (new Date().getTime() >= 禁止拾取时间 && tools.拾取.扫描拾取(拾取范围P, false)) {
                        tools.拾取.点击(1, "攻扫");
                        tools.拾取.等待();
                        tools.拾取.激活后操作();
                    }
                ...
                if (!是否结束攻击) {
                    if (锁定的怪物明细 && 锁定的怪物明细.精英怪 && (精英怪 == null || !精英怪.status)) {
                        精英怪 = {
                            status: true,
                    ...
                    if (身边怪物名称.length <= 0 || (new Date().getTime() - 上一次扫描身边怪物名时间 >= 扫描身边怪物名时间戳 && !是否隐身等待)) {
                        ...
                        if (扫描R.status && 扫描R.name.length > 0) {
                            ...
                            if (身边怪物名称.length > 0 && 挂机参数.挂机地图 != "比奇野外") {
                                扫描身边怪物名失败次数++;
                                toastLog("扫描身边怪名失败[" + 扫描身边怪物名失败次数 + "]")
                            }
                        }
                    }
                    ...
                    if ((!是否隐身等待 || 是否强制攻击) && 身边怪物名称.length > 1 && 扫描身边怪物名失败次数 >= 1) {
                        ...
                        if (r.status) {
                            ...
                            msg += ((t2 - t1) / 1000).toFixed(2);
                            tools.悬浮球描述Temp3(msg + "(" + 向怪物移动次数 + ")");
                            if (r.status) {
                                扫描身边怪物名失败次数 = 0;
                                向怪物移动次数++;
                                tools.click(random(按钮集合.普攻.x[0], 按钮集合.普攻.x[1]), random(按钮集合.普攻.y[0], 按钮集合.普攻.y[1]));
                    ...
                    if (new Date().getTime() - 上一次移动 >= 移动时间戳1) {
                        ...
                        if (!是否跑图) {
                            ...
                            if ((!是否隐身等待 || 是否强制攻击) && 身边怪物名称.length <= 0) {
                                if (挂机参数.隐身走动 == 0) {
                                    var msg = ((new Date().getTime() - 上一次移动) / 1000).toFixed(2) + " , ";
                                    var t1 = new Date().getTime();
                                    r = tools.挂机打怪.向怪物移动();
                                    var t2 = new Date().getTime();
                                    msg += ((t2 - t1) / 1000).toFixed(2);
                    ...
                    if (挂机参数.随机血量 > 0 && tools.挂机打怪.是否自愈()) {
                        tools.挂机打怪.自愈(true);
                    }
                    ...
                    tools.悬浮球描述("[" + 精英怪Str + "](" + ((timeout - (时间戳)) / 1000).toFixed(2) + ") (" + 身边怪物名称 + ") (" + 锁定的怪物明细.name + ")  (" + 怪物.length + " | " + 宝宝身边怪物 + ")");
                } else {
                    // if (!是否已经拾取) {
                    //     tools.拾取.点击(1, msg);
                    //     tools.拾取.等待();
        ...
        是否提前结束攻击: (start, 精英怪, 向怪物移动次数) => {
            ...
            else if (挂机参数.躲避精英 == 1 && 精英怪 != null && 精英怪.status && 精英怪.value.是否躲避) {
                r.status = true;
                r.msg = "躲避精英";
            }
            else if (向怪物移动次数 >= 10) {
                r = tools.挂机打怪.找非满血怪(0, true, true)
                if (!r.status) {
                    tools.人物移动.使用地牢();
                    r.status = true;
                    r.强制跑图 = false;
        ...
        判断经验增加: () => {
            var r = tools.findImageArea("jingyanzhengjia.png", 525, 670, 581, 692, 0.7);
            return r.status;
        },
        关闭中间怪物: (msg) => {
            if (fbl == "1080_2248") {
        ...
        寻找精英怪: () => {
            ...
            else if (挂机参数.挂机地图大.indexOf("石墓阵") >= 0) {
                arr.push({
                    info: 精英怪枚举.白野猪,
                    threshold: 0.85
                })
            ...
            if (arr && arr.length > 0) {
                for (var index = 0; index < arr.length; index++) {
                    var item = arr[index];
                    var r = tools.挂机打怪.匹配指定怪物(item.info.pic, item.threshold, item.info.只攻击满血, item.info.是否锁定, item.info.是否攻击);
                    if (r.status) {
                        result.status = true;
                        result.value = item.info;
                        break;
                    }
                }
            }
        ...
        找满血怪: (顺序, 是否锁定, 是否攻击) => {
            ...
            if (顺序 >= 0) {
                ...
                for (var index = 0; index < 5; index++) {
                    ...
                    var p = config.zuobiao.左攻击面板[fbl].文字顺序[index];
                    var isOk = images.detectsColor(img, item.c2, item.x2, item.y2, 8, "diff")
                    utils.recycleNull(img);
                    var 排除枚举 = [];
                    if (isOk) {
                        ...
                        if (排除枚举 != null && 排除枚举.length > 0) {
                            for (var j = 0; j < 排除枚举.length; j++) {
                                var pic = 排除枚举[j];
                                var r = tools.findImageArea(pic, p.x1, p.y1, p.x2, p.y2, 0.55);
                                if (r.status) {
                                    isOk = false;
                                    break;
                                }
        ...
        跑向怪物: (是否判断血量) => {
            ...
            var 怪物血量左上 = null;
            while (当前总状态 == 总状态.已启动) {
                var 血量是否存在 = tools.挂机打怪.判断中间血量是否存在();
                if (!血量是否存在) {
                    msg = "血量不存在";
                    break;
                }
                ...
                if (是否判断血量 && 挂机参数.只打满血怪 == 1 && !r.是否精英 && tools.挂机打怪.怪物血量是否变化()) {
                    msg = "血量变化";
                    if (怪物血量左上 && tools.挂机打怪.判断锁定怪物周边宝宝是否在(怪物血量左上)) {
                        toastLog("血量变化宝宝存在")
                    }
                    else {
                        toastLog("血量变化")
        ...
        判断是否强制攻击: () => {
            ...
            var 寻人 = tools.挂机打怪.找非满血怪(0, false, false);//注意这里必须提前切换左面板选怪人物
            if (寻人.status) {
        ...
        判断中间血量是否大于65: () => {
            var result = false;
            let img = captureScreen();
            var v0 = images.detectsColor(img, "#FF3300", 666, 39, 6, "diff");//100%血量和0血量会冲突
            if (v0) {
                return true;
            }
            utils.recycleNull(img);
        ...
        判断中间血量是否为0: () => {
            var result = false;
            let img = captureScreen();
            // var v1 = images.detectsColor(img, "#FFFFFF", 629, 38, 6, "diff")
            // var v2 = images.detectsColor(img, "#FFFFFF", 636, 38, 6, "diff")
            // var v3 = images.detectsColor(img, "#FFFFFF", 640, 38, 6, "diff")
            // var v4 = images.detectsColor(img, "#FFFFFF", 652, 44, 6, "diff")
            ...
            var v1 = images.detectsColor(img, "#FFFFFF", 633, 35, 6, "diff")
            var v2 = images.detectsColor(img, "#FFFFFF", 629, 38, 6, "diff")
            var v3 = images.detectsColor(img, "#FFFFFF", 636, 38, 6, "diff")
            var v4 = images.detectsColor(img, "#FFFFFF", 636, 43, 6, "diff")
            var v5 = images.detectsColor(img, "#FFFFFF", 629, 43, 6, "diff")
            var v6 = images.detectsColor(img, "#FFFFFF", 633, 47, 6, "diff")
        ...
        攻击宝宝身边怪物: (宝宝身边怪物, 是否攻击) => {
            if (宝宝身边怪物.status && 宝宝身边怪物.value && 宝宝身边怪物.value.length > 0) {
                ...
                var result = [];
                for (var index = 0; index < 宝宝身边怪物.value.length; index++) {
                    var item = 宝宝身边怪物.value[index];
                    var 绝对值 = Math.abs(人物中心.x - item.x) + Math.abs(人物中心.y - item.y)
                    result.push({
                        绝对值: 绝对值,
                        value: item
                    })
                }
                result.sort((a, b) => a.绝对值 - b.绝对值);
                var 按钮集合 = config.zuobiao.按钮集合[fbl];
                for (var index = 0; index < result.length; index++) {
                    var r = result[index].value;
                    if (r.x >= 245 && r.x <= 915 && r.y >= 60 && r.y <= 556) {
                        if (x >= 247 && x <= 280 && y >= 106 && y <= 328) { //避免点击攻击面板箭头
                            tools.悬浮球描述Temp("避免攻击箭头")
                            continue;
                        }
                        tools.click(r.x + random(3, 8), r.y + random(1, 5));
                        sleep(222);
                        r = tools.挂机打怪.找正上锁定怪物(0, 0);
                        if (r.status) {
                            var isOk = true;
                            if (挂机参数.挂机地图大 == "石墓阵") {
                                var r = tools.findImageArea("wenzhi_zhongjian_shimu_qi.png", 605, 0, 655, 40, 0.5);
                                if (r.status) {
                                    isOk = false;
                                }
                            }
                            if (isOk) {
                                ...
                                tools.挂机打怪.关闭中间怪物("关闭楔蛾");
                            }
                        }
                        else {
                            tools.挂机打怪.关闭中间怪物("锁宠失败");
                        }
                    }
                    else {
                        tools.悬浮球描述Temp("宝宝超出范围")
                    }
                }
            }
            return false;
        ...
        点击挂机坐标: (强制跑图) => {
            ...
            if (挂机参数.反跑地图 == 1) {
                ...
                else if (挂机点跑图顺序 >= 挂机坐标s.result.length) {
                    挂机点跑图顺序 = 0;
                }
            }
            else {
            ...
            if (Array.isArray(r.x)) {
                ...
                x = closeImg.x + (r.x - 偏移.x) + random(-1, 1);
                y = closeImg.y + (r.y - 偏移.y) + random(-1, 1);
            }

            if (箭头P.status && 箭头P.r && Math.abs(箭头P.r.x - x) <= 45 && Math.abs(箭头P.r.y - y) <= 45) {
                //toastLog("到达挂点(" + 挂机点跑图顺序 + ")");
                同一挂点累计点次数 = 0;
                if (挂机参数.反跑地图 == 1) {
                    挂机点跑图顺序--;
                    if (挂机点跑图顺序 < 0) {
            ...
            if (x <= 0 || x > 1028 || y <= 0 || y > 720) {
                toastLog("{x:" + x + ",y:" + y + "}无效");
            }
            else {
                tools.click(x, y)
            }
            tools.悬浮球临时描述("挂点(" + 挂机点跑图顺序 + "|" + 同一挂点累计点次数 + ")")
            是否强制跑图 = false;
            tools.常用操作.关闭所有窗口(false, 0, true);
            return;
        },
        ...
        是否小退: () => {
            var result = false;
            let img = captureScreen();
            var v0 = images.detectsColor(img, "#FF4246", 366, 643, 6, "diff");
            if (v0) {
                var v1 = images.detectsColor(img, "#BF0712", 366, 620, 6, "diff");
                if (!v1) {
                    result = true;
                }
            }
            ...
            // var result = false;
            // var img = captureScreen();
            // var r = images.findMultiColors(img, "#FF4246", [[0, -13, "#B4121E"]], {
            //     region: [365, 610, 3, 50],
            //     threshold: 15
            // });
            // utils.recycleNull(img);
        ...
        获取挂机坐标: () => {
            ...
            } else if (挂机参数.挂机地图 == "幽名圣域") {
                r = config.zuobiao.盟重大地图偏移[fbl].幽名圣域.打怪点;
        ...
        快速检查宝宝: () => {
            ...
            var 当前模式 = null;
            sleep(333)
            var r = tools.findImageArea(文字图枚举.攻击, p.x1, p.y1, p.x2, p.y2, 0.8);
            if (r.status) {
                当前模式 = "攻击";
                return;
            }
            else {
                r = tools.findImageArea(文字图枚举.休息, p.x1, p.y1, p.x2, p.y2, 0.8);
                if (r.status) {
                    当前模式 = "休息";
                }
                else {
        ...
        排序怪物空位: (怪物坐标) => {
            ...
            if (怪物坐标.x < 人物中心.x) {
                if (怪物坐标.y < 人物中心.y) { //怪物在左上
                    result.push(arr[1]); //左上
                    result.push(arr[0]); //左边
                    result.push(arr[6]); //上边

                    result.push(arr[2]); //左下
                    result.push(arr[4]); //右上

                    result.push(arr[3]); //右边
                    result.push(arr[5]); //右下
                    result.push(arr[7]); //下边
                }
                else { //怪物在左下
                    result.push(arr[2]); //左下
                    result.push(arr[0]); //左边
        ...
        获取人物身边怪物数据: () => {
            ...
            var color = "#DB0000";
            var result = [];
            var regions = config.zuobiao.人物身边怪物[fbl];
        ...
        获取宝宝身边怪物数据: (status) => {
            ...
            if (r.status) {
                ...
                if (fbl == "1080_2248") {
                    regions = [
                        [p.x - 2, p.y - 66, 70, 30], // 正上方
                        [p.x - 85, p.y - 66, 70, 30], // 左上方
                        [p.x + 85, p.y - 66, 70, 30], // 右上方

                        [p.x - 2, p.y + 66, 70, 30], // 正下方
                        [p.x - 85, p.y + 66, 70, 30], // 左下方
                        [p.x + 85, p.y + 66, 70, 30], // 右下方

                        [p.x - 85, p.y - 8, 70, 16], // 正左方
                        [p.x + 85, p.y - 8, 70, 16], // 正右方
                    ]
                }
                regions.forEach((reg, index) => {
                    var r = null;
        ...
        扫描身边怪物名: () => {
            ...
            var r = tools.挂机打怪.扫描怪物名图片(锁定的怪物明细, 身边范围P, true);
            if (r.status) {
                return {
                    status: true,
                    name: r.name,
        ...
        扫描怪物名图片: (文字枚举, p, 是否额外) => {
            ...
            if (是否额外) {
                ...
                for (var index = 0; index < arr.length; index++) {
                    var item = arr[index];
                    if (item && item.name) {
                        if (文字枚举 == null || item.name != 文字枚举.name) {
                            怪物集合.push(item);
                        }
                    }
                }
        ...
        怪物血量是否变化: () => {
            ...
            var c = config.找色[fbl].血量变动;
            var img = captureScreen();
            var r = images.findMultiColors(img, c.c0, [[c.x1, c.y1, c.c1], [c.x2, c.y2, c.c2], [c.x3, c.y3, c.c3], [c.x4, c.y4, c.c4]], {
                region: [p.x1, p.y1, p.x2 - p.x1, p.y2 - p.y1],
                threshold: 15
            });
            utils.recycleNull(img);
            ...
            // var r = tools.findImageArea("zhongjianxueLiang100.png", p.x1, p.y1, p.x2, p.y2, 0.9);
            // if (r.status) {
            //     return false;
            // }
            // else {
    ...
    拾取: {
        ...
        点击: (type, 来源) => {//1是为了激活，0是为了取消激活
            var 拾取 = config.zuobiao.按钮集合[fbl].拾取;
            var 是否激活状态 = tools.拾取.状态();
            if (type == 1) {
                tools.悬浮球描述Temp2("拾(" + 来源 + ")")
                if (是否激活状态) {
                    toastLog("激活中(" + 来源 + ")")
                    return;
                }
                上次坐标截图 = tools.常用操作.截图当前坐标();
                上一次激活拾取时间 = new Date().getTime();
            } else {
                tools.悬浮球描述Temp4(",(" + 来源 + ")")
                if (!是否激活状态) {
                    return;
        ...
        扫描拾取: (p, 是否识别金币) => {
            ...
            if (r && (r.x > 0 || r.y > 0)) {
                ...
                if (r.x >= 限制p.x1 && r.x <= 限制p.x2 && r.y >= 限制p.y1 && r.y <= 限制p.y2) {
                    var picR = tools.findImageArea("shiqubiaoji.png", 限制p.x1 - 50, 限制p.y1 - 50, 限制p.x2 + 50, 限制p.y2, 0.6);
                    if (!picR.status) {
                        isok = false;
                    }
                }
            ...
            if (是否识别金币) {
                c = config.找色[fbl].扫描拾取金币;
                r = images.findMultiColors(img, c.c0, [[c.x1, c.y1, c.c1], [c.x2, c.y2, c.c2], [c.x3, c.y3, c.c3]], {
                    threshold: 35
                });
                if (r && (r.x > 0 || r.y > 0)) {
                    if (r.x >= 484 && r.x <= 881 && r.y >= 615 && r.y <= 700) {
                        utils.recycleNull(img);
                        return false;
                    }
                    toastLog("金币" + r.x + "|" + r.y)
        ...
        是否排除强制拾取: () => {
            ...
            //     }
            // }
            var r = tools.findImageAreaForWait("wenzhi_shiqu_jingbi_bai.png", 范围.x1, 范围.y1, 范围.x2, 范围.y2, {
                maxTries: 5,
                interval: 200,
                threshold: 0.6
            });
            ...
            // var c = config.找色[fbl].扫描拾取金币;
            // var r = images.findMultiColors(img, c.c0, [[c.x1, c.y1, c.c1], [c.x2, c.y2, c.c2], [c.x3, c.y3, c.c3]], {
            //     region: [范围.x1, 范围.y1, 范围.x2 - 范围.x1, 范围.y2 - 范围.y1],
            //     threshold: 40
            // });
            // utils.recycleNull(img);
            // if (r && (r.x > 0 || r.y > 0)) {
        ...
        等待: () => {
            var t1 = new Date().getTime();
            while (当前总状态 == 总状态.已启动) {
                var r = tools.findImageArea("shiquzhanwu.png", 490, 670, 529, 692, 0.75);
        ...
        激活后操作: () => {
            ...
            while (当前总状态 == 总状态.已启动) {
                ...
                if (执行强制拾取) {
                    if (new Date().getTime() - 上一次隐身 >= 隐身时间戳) {
                        tools.挂机打怪.启动隐身();
                        上一次隐身 = new Date().getTime();
                    }
                    if (!tools.拾取.扫描脚下是否有物品()) {
                        扫描脚下无物品次数++;
                    }
                    if (扫描脚下无物品次数 > 5) {
                        扫描脚下无物品次数 = 0;
                        tools.拾取.点击(0, ",");
                        sleep(666);
                        tools.拾取.点击(1, "无物品(" + 扫描脚下无物品次数 + ")");
                        sleep(999);
                    }
                    var 是否排除 = tools.拾取.是否排除强制拾取();
                    if (是否排除.status) {
                        强制拾取后再次判断排除次数++;
                    }
                    if (强制拾取后再次判断排除次数 > 5) {
                    ...
                    tools.悬浮球描述Temp2("" + parseInt((拾取时长 - (new Date().getTime() - start)) / 1000));
                    continue;
                }
                else {
                    tools.悬浮球描述("拾取中(" + parseInt((拾取时长 - (new Date().getTime() - start)) / 1000) + ")");
                }
    ...
    人物移动: {
        获取人物空位: () => {
            ...
            var color = "#DB0000";//红血条
            var color2 = "#00BF00";//蓝血条
            var 点击范围 = config.zuobiao.人物点击范围全部[fbl];
            for (var index = 0; index < 点击范围.length; index++) {
                var item = 点击范围[index];
                var r1 = images.findColor(img, color, {
        ...
        跑图坐标是否变化: () => {
            ...
            var r = utils.regionalFindImg2(img, 上次坐标截图, p.x1, p.y1, p.x2, p.y2, 60, 255, 0.99, false, false, "");
            utils.recycleNull(img);
            if (r != null && (r.x > 0 || r.y > 0)) {
                return false;
            } else {
        ...
        检测地图走动方向: (当前地图) => {
            ...
            if (isCheck) {
                var r = tools.findImageForWaitClick("fenshenjiashiBtn.png", {
                    maxTries: 5,
                    interval: 200
                })
                if (r.status) {
        ...
        去小贩Loop: () => {
            var 是否宝宝休息 = false;
            while (当前总状态 == 总状态.已启动) {
                tools.常用操作.及时执行事件(true, "去小贩Loop", true);
                var 人物坐标 = tools.常用操作.获取人物坐标();
                var 当前地图 = tools.常用操作.获取人物地图();
        ...
        回老兵Loop: () => {
            ...
            while (当前总状态 == 总状态.已启动) {
                tools.常用操作.及时执行事件(true, "回老兵Loop", true);
                var 当前地图 = tools.常用操作.获取人物地图();
        ...
        去下一层地图: (当前地图, 目的地) => {
            ...
            if (下一层 && 下一层.入口 && 箭头P.status) {
                var 入口 = {
                    ...
                    y: 下一层.入口[fbl].y - 偏移.y + closeImg.y,
                }
            ...
            for (var i = 0; i < routes.length; i++) {
                ...
                if (i < routes.length - 1) {
                    if (info && info.pic && info.范围 && info.pic.length > 0) {
                        var 范围p = info.范围[fbl];
        ...
        去挂机地图Loop: () => {
            ...
            for (let index = 0; index < routesGroup.length; index++) {
                ...
                while (当前总状态 == 总状态.已启动) {
                    tools.常用操作.及时执行事件(true, "去挂机地图Loop", true);
                    tools.常用操作.跑图累计错误执行();
                    ...
                    if (是否沿途打怪 && 挂机参数.沿途打怪 == 1) {
                        ...
                        if (精英怪.status) {
                            ...
                            var now = new Date().getTime();
                            if (now >= 禁止拾取时间 && now - 上一次激活拾取时间 > 激活拾取时间戳 && tools.拾取.扫描拾取(null, false)) {
                                tools.拾取.点击(1, " 去挂机图");
                                tools.拾取.等待();
                                tools.拾取.激活后操作();
                            }
    ...
    补给操作: {
        ...
        喝蓝_背包: (zhengliBtn, isClose) => {
            ...
            if (arrClick && arrClick.length > 0) {
                for (let index = 0; index < arrClick.length; index++) {
                    tools.常用操作.及时执行事件(true, "喝蓝_背包", true);
        ...
        找蓝个: () => {
            var img = captureScreen();
            var 判断蓝 = config.找色[fbl].判断蓝;
            var r = images.findMultiColors(img, 判断蓝.c0, [[判断蓝.x1, 判断蓝.y1, 判断蓝.c1]], {
                region: 判断蓝.p,
                threshold: 35
            });
            utils.recycleNull(img);
        ...
        获取操作按钮(按钮类型, 来源, isClick, notFindEixt, isBoss) {
            ...
            while (true) {
                ...
                for (let index = 0; index < 按钮类型.length; index++) {
                    ...
                    switch (item) {
                        ...
                        case "穿戴":
                            ...
                            btn2Name = "beibaochuandaiBtn2.png";
                            break;
                        case "使用":
                    ...
                    r = tools.findImage(btnName, 0.8);
                    if (r.status) {
                        sucessBtn = btnName;
                        break;
                    }
                    else {
                        r = tools.findImage(btn1Name, 0.8);
                        if (r.status) {
                            sucessBtn = btn1Name;
                            break;
                        }
                        else if (btn2Name != null && btn2Name.length > 0) {
                            r = tools.findImage(btn2Name, 0.8);
                            if (r.status) {
                                sucessBtn = btn2Name;
                                break;
                            }
                ...
                if (r.status) {
                    if (isClick) {
                        ...
                        var y = r.img.y + r.size.h / 2 + random(3, 6);
                        tools.click(x, y)
                    }
                    return {
                        status: true,
            ...
            if (!r) { //如果没在游戏画面大概率是花屏了
                if (notFindEixt) {
                    当前总状态 = 总状态.小退中;
                    tools.常用操作.小退(JSON.stringify(按钮类型) + "获取操作按钮失败(" + 来源 + ")", true)
        ...
        当放入按钮找不到(zhengliBtn, notFindEixt, 来源) {
            ...
            if (chuandaiOk && shiYongOk) {
                ...
                if (notFindEixt) {
                    当前总状态 = 总状态.小退中;
                    tools.常用操作.小退("chuandaiOk=" + chuandaiOk + ",shiYongOk=" + shiYongOk + ",操作按钮失败(" + 来源 + ")", true);
                }
                return {
                    status: false
                }
        ...
        获取1和2持久: (btn) => {
            ...
            if (btn && btn.status) {
                ...
                var p = {
                    x1: btn.img.x + 装备属性明细.x,
                    y1: btn.img.y + 装备属性明细.y偏移,
                    x2: btn.img.x,
                    y2: btn.img.y + 装备属性明细.第三行h,
                }
                result = tools.findImageArea("check_chijiu_fu1.png", p.x1, p.y1, p.x2, p.y2, 0.7);
                if (result.status) {
                    return 1;
                }
                result = tools.findImageArea("check_chijiu_fu2.png", p.x1, p.y1, p.x2, p.y2, 0.7);
                if (result.status) {
                    return 2;
                }
            }
        ...
        获取物品信息: (btn) => {
            if (btn && btn.status) {
                var p = btn.img;
                var 装备属性明细 = config.zuobiao.人物面板[fbl].装备属性明细;
                var img = tools.截屏裁剪(null, p.x + 装备属性明细.x, p.y + 装备属性明细.y偏移, p.x, p.y + 装备属性明细.y偏移 + 装备属性明细.第三行h);
        ...
        判断选中格子是否极品: (btn) => {
            if (btn && btn.status) {
                var p = btn.img;
                var 装备属性明细 = config.zuobiao.人物面板[fbl].装备属性明细;
                var 极品 = config.找色[fbl].极品;
                var img = captureScreen();
                var r = images.findMultiColors(img, 极品[0].color, [[极品[1].x, 极品[1].y, 极品[1].color], [极品[2].x, 极品[2].y, 极品[2].color], [极品[3].x, 极品[3].y, 极品[3].color]], {
        ...
        判断选中格子是否存仓库: (zhengliBtn, btn, index1, index2) => {
            var arr = [{
                ...
                pic: 补给枚举.组队卷,
                验证文字: false,
                //是否提醒: 挂机参数.挂机地图大 == "石墓阵" ? true : false,
                是否提醒: false,
                同时验证: false,
            }, {
                name: "祈祷之刃",
            ...
            for (let index = 0; index < arr.length; index++) {
                ...
                if (item.同时验证) {
                    ...
                    if (item.验证文字) {
                        ...
                        if (r.status && item.name == "井中月") {
                            r = tools.补给操作.背包选中按钮中找字图("wenzi_zhuangbei_jingzhongyue1.png", btn)
                        }
                    }
                    else {
        ...
        背包选中按钮中找字图: (字图, btn, t) => {
            ...
            if (btn && btn.status) {
                var p = btn.img;
                var 装备属性明细 = config.zuobiao.人物面板[fbl].装备属性明细;
                var r = tools.findImageArea(字图, p.x + 装备属性明细.x, p.y + 装备属性明细.y偏移, p.x, p.y + 装备属性明细.y偏移 + 装备属性明细.第三行h, 0.7);
                return r;
            }
            else {
                return {
        ...
        点击分身: () => {
            if (挂机参数.补给时点分身 == 1) {
                ...
                while (true) {
                    tools.常用操作.及时执行事件(false, "点击分身", false);
                    sleep(random(1500, 2000));
        ...
        卖物品: () => {
            ...
            for (let index = 1; index <= 5; index++) {
                for (let index1 = 1; index1 <= 8; index1++) {
                    ...
                    tools.常用操作.及时执行事件(false, "卖物品", false);
                    sleep(888)
                    ...
                    if (info.物品名称 == "护身符大") {
                        var 持久12 = tools.补给操作.获取1和2持久(r.value);
                        if (持久12 <= 0) {
        ...
        把药品格非蓝拖到背包: () => {
            ...
            sleep(1000)
            for (let index = 0; index < arr.length; index++) {
                tools.常用操作.及时执行事件(false, "把药品格非蓝拖到背包", false);
                var 药品格子P = arr[index];
        ...
        寻找装备: (zhengliBtn, picName) => {
            var 背包面板P = tools.补给操作.获取背包面板位置(zhengliBtn);
            var arr = tools.matchTemplateForArea(picName, 2, 0.7,
            ...
            if (arr.count > 0) {
                ...
                for (var index = 0; index < arr.count; index++) {
                    ...
                    else if (picName == 装备枚举.黑色戒指 || picName == 装备枚举.降妖戒指 || picName == 装备枚举.珊瑚戒指) {
                        var isok = true;
                        if (picName == 装备枚举.珊瑚戒指) {
                            if (!r.status || (r.value.indexOf("珊") < 0 && r.value.indexOf("瑚") < 0)) {
                                isok = false;
                            }
                        }
                        if (isok) {
        ...
        替换装备: () => {
            ...
            if (挂机参数.替换珊瑚 == 1) {
                result.push(装备枚举.珊瑚戒指);
            }



            for (var index = 0; index < result.length; index++) {
                tools.常用操作.及时执行事件(false, "替换装备", false);
                var pic = result[index];
                sleep(random(666, 888));
                var arr = tools.补给操作.寻找装备(zhengliBtn, pic);
                if (arr && arr.length > 0) {
        ...
        买物品Loops: () => {
            ...
            if (物品集合 != null && 物品集合.length > 0) {
                ...
                var 护身符数量 = tools.matchTemplate(补给枚举.护身符, 5, 0.75).count;

                var 灰毒数量 = tools.matchTemplate(补给枚举.灰毒, 2, 0.7).count;
                ...
                if (物品S1.length > 0) {
                    ...
                    for (var i = 0; i < 物品S1.length; i++) {
                        var item = 物品S1[i];
                        var 页码 = item["页码"];
                        tools.悬浮球描述(item["名称"] + "：页码=" + 页码 + "，当前页码" + 当前页码)
                        if (页码 != 当前页码) {
                            var 差值 = 页码 - 当前页码;
                            for (var j = 0; j < 差值; j++) {
        ...
        //         for (var i = 0; i < 物品集合.length; i++) {
        //             if (当前总状态 == 总状态.已启动) {
        //                 tools.常用操作.及时执行事件(false, "买物品Loops", false);
        //                 var 物品对象 = 物品集合[i];
        //                 var buyNum = 物品对象["数量"];
        ...
        存仓库: (index1, index2) => {
            ...
            r = tools.findImageForWait("cangku_null.png", {
                maxTries: 10,
                interval: 666
            });
            if (!r.status) {
                tools.常用操作.小退("仓库已满", true)
                return {
                    status: false,
                    err: "仓库可能已满！！！"
                }
            ...
            tools.补给操作.点击背包格子(index1, index2, zhengliBtn);
        ...
        修理装备: () => {
            ...
            for (let index = 1; index <= 5; index++) {
                for (let index1 = 1; index1 <= 8; index1++) {
                    tools.常用操作.及时执行事件(false, "修理装备", false);
                    if (true) {
                        if (index == 1 && index1 == 1) {
                            sleep(1200)
                        }
                    ...
                    var info = tools.补给操作.判断选中格子动作(true, false, true, zhengliBtn, r.value, index, index1);
                    if (info.是否跳过) {
                        是否返回修理 = false;
                        if (info.物品名称 == "中蓝包") {
                            toastLog("发现中蓝包结束");
        ...
        穿装备Loop: () => {
            ...
            if (zhengliBtn.status) {
                for (let index = 1; index <= 5; index++) {
                    for (let index1 = 1; index1 <= 8; index1++) {
                        tools.常用操作.及时执行事件(false, "穿装备Loop", false);
                        tools.补给操作.点击背包格子(index, index1, zhengliBtn);
                        ...
                        if (r.status) {
                            ...
                            if (info.是否跳过) {
                                ...
                                var btn = r.value;
                                var x = btn.img.x + btn.size.w / 2 + random(5, 10);
                                var y = btn.img.y + btn.size.h / 2 + random(3, 6);
                                sleep(random(333, 444))
                                tools.click(x, y)
                            }
                        }
        ...
        取武器衣服: () => {
            ...
            for (let index = 0; index < arr.length; index++) {
                ...
                if (r.status && r.img.x > 0) {
                    ...
                    tools.常用方法.发送提醒("仓库中无" + item.name)
                }
            }
        ...
        检测聊天框持久提示: () => {
            var p = config.zuobiao.聊天框面板[fbl];
            if ((new Date().getTime() - 上一次武器持久提示时间) >= 1000 * 10) {
                var r = tools.findImageArea(持久提示枚举.凝霜, p.x1, p.y1, p.x2, p.y2, 0.85);
                if (r.status) {
                    是否替换武器 = true;
                    tools.悬浮球描述Temp("等待无怪替换武器");
                    上一次武器持久提示时间 = new Date().getTime() + 1000 * 60 * 2;
                }
            }
            if ((new Date().getTime() - 上一次衣服持久提示时间) >= 1000 * 10) {
                r = tools.findImageArea(持久提示枚举.重盔, p.x1, p.y1, p.x2, p.y2, 0.85);
                if (r.status) {
                    是否替换衣服 = true;
                    tools.悬浮球描述Temp("等待无怪替换衣服");
                    上一次衣服持久提示时间 = new Date().getTime() + 1000 * 60 * 2;
                }
            }
        },
    },
    验证码认证: {
        检测是否有认证: (img) => {
            ...
            var p = config.zuobiao.验证码[fbl].出现范围;
            var colorArr = config.zuobiao.验证码[fbl].找色;
        ...
        处理认证: (认证P) => {
            ...
            if (r) {
                var 刷新P = config.zuobiao.验证码[fbl].刷新按钮;
                // sleep(1500);
                // tools.click(刷新P.x + random(-5, 5), 刷新P.y + random(-3, 3));
                var tryCount = 0;
                while (true) {
                    if (tryCount >= 6) {
                        break;
        ...
        截图认证Base64: () => {
            var img = captureScreen();
            var 截图P = config.zuobiao.验证码[fbl].截图范围;
        ...
        云码认证: () => {
            ...
            if (res && res.statusCode == 200) {
                ...
                if (r.code == 10000) {
                    var x = 0;
                    try {
                        x = parseInt(r.data.data);
                    } catch (error) {
                        x = 0;
                    }
                    if (x > 0) {
                        var 偏移 = config.zuobiao.验证码[fbl].云码偏移;
                        return {
                            status: true,
                            value: {
                                x: parseInt(r.data.data) + 偏移,
                                y: 0
                            }
                        }
                    }
        ...
        滑动验证码: (x, y) => {
            var 拖动条中心 = config.zuobiao.验证码[fbl].拖动条中心;
            var 拖动条P = {
                x: 拖动条中心.x + random(-1, 1),
                y: 拖动条中心.y + random(-3, 3),
            }
            var 截图P = config.zuobiao.验证码[fbl].截图范围;
        ...
        登录验证码: () => {
            var img = captureScreen();
            var pic = tools.截屏裁剪(img, 510, 242, 752, 362);
            var base64Str = android.util.Base64.encodeToString(images.toBytes(pic, "png"), 0);
            utils.recycleNull(pic);
    ...
    悬浮球描述Temp2: (text) => {
        if (text) {
            ui.run(() => {
                //windowTemp.temp1Text.setText(text + "(" + new Date().getTime().toString().slice(-4) + ")");
                windowTemp.temp3Text.setText(text);
            });
        }
    },
    悬浮球描述Temp3: (text) => {
        if (text) {
            ui.run(() => {
                windowTemp.temp4Text.setText(text);
            });
        }
    },
    悬浮球描述Temp4: (text) => {
        if (text) {
            ui.run(() => {
                windowTemp.temp5Text.setText(text);
            });
        }
    },
    悬浮球临时描述: (text) => {
    ...
    findImage: (fileName, threshold, img) => {
        ...
        //shiqubiaoji
        if (fileName != "closeBtn.png" && fileName != "closeBtn2.png" && fileName != "shiqubiaoji.png") {
            tools.悬浮球描述('找图失败' + fileName);
        }
        return {
            status: false,
    ...
    findImageArea(fileName, x1, y1, x2, y2, threshold, img) {
        var options = {
            threshold: 0.7
        };
        if (threshold && threshold > 0) {
    ...
    click: (x, y) => {
        ...
        else if (x >= 410 && x <= 960 && y >= 618 && y <= 720) { //避免点到聊天框
            var r = tools.findImageArea("chongBtn.png", p.x1, p.y1, p.x2, p.y2, 0.8);
            if (r.status) {
                return false;
            }
        }
        // else if (x >= 247 && x <= 280 && y >= 106 && y <= 328) { //避免攻击面板箭头
        //     return false;
        // }
        else if (x >= 460 && x <= 500 && y >= 552 && y <= 586) { //避免聊天面板
            return false;
        }
...
ui.run(() => {
    ...
    win.btnSave.click(() => {
        ...
        挂机参数 = {
            ...
            检宠身边: win.cbTiHuanMingZhu.isChecked() ? 1 : 0,
            ...
            替换珊瑚: win.cbTiHuanDaoDe.isChecked() ? 1 : 0,
            ...
            是否队长: win.cbIsWuFeiHuiCheng.isChecked() ? 1 : 0,
            ...
            躲避精英: win.cbDiTuTuoDong.isChecked() ? 1 : 0,
            扫描精英: win.cbIsGenSuiBaoBao.isChecked() ? 1 : 0,
            挂机地图: 挂机地图,
            挂机城市: 挂机城市,
            挂机地图大: 挂机地图大,
    ...
    windowTemp.clearText.click(() => {
        ui.run(() => {
            windowTemp.temp1Text.setText("");
            windowTemp.temp3Text.setText("");
            windowTemp.temp4Text.setText("");
            windowTemp.temp5Text.setText("");
        });
    })
    win.setSize(w, h);
    win.setPosition(-10000, padding_top);
...
// var zhengliBtn = tools.补给操作.整理背包(true);
// tools.常用操作.使用备用装备(装备枚举.凝霜, zhengliBtn);
...
// sleep(999999)
// sleep(3000)
// tools.人物移动.去下一层地图("地牢一层西1", "地牢一层北2")
...
// toastLog(isSuccess)
// sleep(20000)
// var r = tools.补给操作.获取操作按钮(["放入"], "卖物品", false, false, true);
// var 符持久 = tools.补给操作.获取护身符持久(r.value);
// toastLog("" + 符持久)
...
// var r = tools.拾取.识别金币();
// var t2 = new Date().getTime();
// tools.悬浮球临时描述(JSON.stringify(r) + " | " + ((t2 - t1) / 1000).toFixed(2) + ")")
// sleep(99999999);
...
threads.start(function () {
    ...
    while (true) {
        ...
        if (当前总状态 == 总状态.已启动 && !打怪提醒 && (new Date().getTime() - 上一次启动执行时间) > (1000 * 60 * 30)) {
            tools.常用方法.发送提醒("30分钟以上未执行打怪");
            打怪提醒 = true;
        }
        sleep(1000 * 3); // 每秒更新一次
    }
